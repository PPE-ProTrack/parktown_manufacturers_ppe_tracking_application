...
class PendingReturnsActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener
    , PendingReturnsAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pending_returns)

        toolbar = findViewById(R.id.toolbar)
        navigationView = findViewById(R.id.nav_view)
        drawerLayout = findViewById(R.id.pending_returns_drawerLayout)
        progressbar = findViewById(R.id.progressBar)
        progressbar.bringToFront()
        progressbar.visibility = View.VISIBLE

        recordsbtn = findViewById(R.id.records_button)
        ...
        val recyclerView: RecyclerView = findViewById(R.id.pending_returns_RecyclerView)

        recyclerView.adapter = PendingReturnsAdapter(PendingReturnsManager.pendingReturnsList, this)
    ...
    object PendingReturnsManager{
        val pendingReturnsList: MutableList<PendingReturnsData> = mutableListOf(
            PendingReturnsData(
                recordId = 1,
                empId = 1,
